...
-->
``` http
GET /driveItem/workbook/names/{workbookNamedItemId}/worksheet/tables
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/names/{workbookNamedItemId}/worksheet/tables
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.ExcelServices.workbookTable)"
}
-->
``` http
HTTP/1.1 200 OK
