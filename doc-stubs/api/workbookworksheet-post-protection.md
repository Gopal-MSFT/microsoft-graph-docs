...
-->
``` http
POST /driveItem/workbook/names/{workbookNamedItemId}/worksheet/protection
```
...
-->
``` http
POST https://graph.microsoft.com/beta/driveItem/workbook/names/{workbookNamedItemId}/worksheet/protection
