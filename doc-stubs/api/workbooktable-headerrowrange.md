...
-->
``` http
GET /driveItem/workbook/tables/{workbookTableId}/headerRowRange
GET /driveItem/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/headerRowRange
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/tables/{workbookTableId}/headerRowRange
```
