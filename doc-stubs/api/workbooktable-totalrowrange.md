...
-->
``` http
GET /driveItem/workbook/tables/{workbookTableId}/totalRowRange
GET /driveItem/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/totalRowRange
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/tables/{workbookTableId}/totalRowRange
```
