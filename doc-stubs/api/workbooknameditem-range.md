...
-->
``` http
GET /driveItem/workbook/names/{workbookNamedItemId}/range
GET /driveItem/workbook/names/{workbookNamedItemId}/worksheet/names/{workbookNamedItemId}/range
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/names/{workbookNamedItemId}/range
```
