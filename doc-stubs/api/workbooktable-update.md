...
-->
``` http
PATCH /driveItem/workbook/tables/{workbookTableId}
PATCH /driveItem/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/driveItem/workbook/tables/{workbookTableId}
