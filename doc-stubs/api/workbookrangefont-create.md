...
-->
``` http
POST ** Collection URI for Microsoft.ExcelServices.workbookRangeFont not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.workbookRangeFont not found
