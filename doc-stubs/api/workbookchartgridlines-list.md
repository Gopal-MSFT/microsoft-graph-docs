...
-->
``` http
GET ** Collection URI for Microsoft.ExcelServices.workbookChartGridlines not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.workbookChartGridlines not found
```
