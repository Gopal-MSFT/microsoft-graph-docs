...
-->
``` http
GET /driveItem/workbook/names/{workbookNamedItemId}/worksheet/names
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/names/{workbookNamedItemId}/worksheet/names
```
