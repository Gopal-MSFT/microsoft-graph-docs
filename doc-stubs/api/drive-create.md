...
-->
``` http
POST ** Collection URI for Microsoft.ExcelServices.drive not found
```
...
<!-- {
  "blockType": "request",
  "name": "create_drive_from_"
}
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.drive not found
