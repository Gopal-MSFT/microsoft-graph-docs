...
-->
``` http
POST /driveItem/workbook/names/{workbookNamedItemId}/worksheet/names
```
...
-->
``` http
POST https://graph.microsoft.com/beta/driveItem/workbook/names/{workbookNamedItemId}/worksheet/names
