...
-->
``` http
POST ** Collection URI for Microsoft.ExcelServices.workbookChartFill not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.workbookChartFill not found
