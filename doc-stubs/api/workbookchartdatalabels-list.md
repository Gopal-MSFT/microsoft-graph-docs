...
-->
``` http
GET ** Collection URI for Microsoft.ExcelServices.workbookChartDataLabels not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.workbookChartDataLabels not found
```
