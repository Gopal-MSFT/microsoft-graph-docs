...
-->
``` http
GET ** Collection URI for Microsoft.ExcelServices.driveItem not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.driveItem not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.ExcelServices.driveItem)"
}
-->
``` http
HTTP/1.1 200 OK
