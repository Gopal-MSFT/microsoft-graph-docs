...
-->
``` http
GET ** Collection URI for Microsoft.ExcelServices.drive not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.drive not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.ExcelServices.drive)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#Microsoft.ExcelServices.drive"
    }
  ]
}
```
