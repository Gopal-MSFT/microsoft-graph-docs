...
-->
``` http
GET /driveItem/workbook/operations
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/operations
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.ExcelServices.workbookOperation)"
}
-->
``` http
HTTP/1.1 200 OK
