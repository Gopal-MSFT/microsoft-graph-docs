...
-->
``` http
GET /driveItem/workbook/tables/{workbookTableId}/range
GET /driveItem/workbook/names/{workbookNamedItemId}/worksheet/tables/{workbookTableId}/range
```
...
-->
``` http
GET https://graph.microsoft.com/beta/driveItem/workbook/tables/{workbookTableId}/range
```
