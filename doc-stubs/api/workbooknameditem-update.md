...
-->
``` http
PATCH /driveItem/workbook/names/{workbookNamedItemId}
PATCH /driveItem/workbook/names/{workbookNamedItemId}/worksheet/names/{workbookNamedItemId}
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/driveItem/workbook/names/{workbookNamedItemId}
