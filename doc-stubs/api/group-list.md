...
-->
``` http
GET ** Collection URI for Microsoft.ExcelServices.group not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for Microsoft.ExcelServices.group not found
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(Microsoft.ExcelServices.group)"
}
-->
``` http
HTTP/1.1 200 OK
...

{
  "value": [
    {
      "@odata.type": "#Microsoft.ExcelServices.group"
    }
  ]
}
```
